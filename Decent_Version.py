...
FIND_OPPONENT_SAMPLE_DELAY = 5  # Delay between proximity samples while spinning
...
while True:
    ...
    while True:
        ...
        if total > OPPONENT_THRESHOLD:  # If enemy detected
            ...
            charge()  # Go forward
            time.sleep_ms(CHARGE_DURATION_MS)  # Hold charge
            ...
            motors.off()  # Stop
            show_proximity(left, right, "Scanning")  # Idle display
